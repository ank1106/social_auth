...
def get_linkedin_meta(access_token):
    user_meta = requests.get('https://api.linkedin.com//v2/me/',
                             headers={"Authorization": "Bearer {}".format(access_token)})
    user_email = requests.get('https://api.linkedin.com/v2/emailAddress?q=members&projection=(elements*(handle~))',
                              headers={"Authorization": "Bearer {}".format(access_token)})
